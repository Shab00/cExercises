...
union intParts {
  int ints[6];        // To hold the 6 integers
  char chars[6 * sizeof(int)]; // To interpret the memory as a contiguous array of characters
};
...
int main() {
        ...
        union intParts intCharacters = {{1853169737, 1936876900, 1684955508, 1768838432, 561213039, 0}};
